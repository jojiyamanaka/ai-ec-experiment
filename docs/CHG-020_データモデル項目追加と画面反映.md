...
| `api/customer-bff-openapi.json` | 顧客向けオブジェクト型・エンドポイント定義を更新 |
| `api/backoffice-bff-openapi.json` | 管理向けオブジェクト型・エンドポイント定義を更新 |
| `api/openapi.json` | Core API のオブジェクト型・エンドポイント定義を更新 |
