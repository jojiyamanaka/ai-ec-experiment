...
**ステータス**: ✅ 要件化済み → `docs/01_requirements/REQ-001_在庫不足詳細エラー.md`
...
**参照**:
- 要件定義: `docs/01_requirements/REQ-002_非公開商品カート整合性.md`
...
1. **M-2**~~: 在庫不足時の詳細エラーレスポンス実装~~ ✅ 完了
2. **M-3**~~: 非公開商品のカート自動削除機能~~ ✅ 完了
